...
const ComparisonChart: React.FC<ComparisonChartProps> = ({ data }) => {
  ...
  return (
    <div className="w-full bg-white dark:bg-slate-850 rounded-xl p-6 border border-gray-200 dark:border-slate-700 shadow-lg transition-colors duration-300">
      <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-6 flex items-center gap-2">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-primary-600 dark:text-primary-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="h-[400px] w-full text-xs">
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <Tooltip 
              contentStyle={{ backgroundColor: 'var(--tooltip-bg, #1e293b)', borderColor: '#475569', color: 'var(--tooltip-text, #f1f5f9)' }}
              itemStyle={{ color: 'var(--tooltip-item, #cbd5e1)' }}
            />
